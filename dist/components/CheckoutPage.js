                            ...
                            : currentStep === 'completed'
                                ...
                                : currentStep === 'error'
                                    ...
                                    : isProcessing
                                        ...
                                        : `💳 Pay ${amount} USDC` }), (currentStep === 'completed' || currentStep === 'error') && (_jsxs(Button, { onClick: reset, className: "w-full h-12 flex items-center justify-center bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-200", children: [_jsx(RefreshCw, { className: "w-4 h-4 mr-2" }), "Start New Payment"] }))] })] }));
}
